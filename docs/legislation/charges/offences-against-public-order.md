...
<div class="charges-container">
  ...
  <div class="charge felony-charge">
    <div class="felony"></div>
    <div class="charge-content">
      <div class="charge-row charge-name">Disruption of a Public Utility (FELONY)</div>
      <div class="charge-row principal">Principal - 28 months - $1260</div>
      <div class="charge-row accomplice">Accomplice - 28 months - $1260</div>
      <div class="charge-row accessory">Accessory - 23 months - $1070</div>
      <div class="charge-description">
        <strong>Description:</strong>
        Interfering with, disabling, or obstructing the operation of public utilities, including electricity, water, or communication systems.
        <br><br>
        <strong>Points to Prove:</strong>
        <ul>
          <li>The defendant intentionally disrupted a public utility.</li>
          <li>The utility provides essential services to the public.</li>
          <li>The act caused risk or actual interruption of service.</li>
        </ul>
      </div>
    </div>
  </div>
